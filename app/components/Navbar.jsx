...
const Navbar = ({ isDarkMode, setIsDarkMode }) => {
  const [isScroll, setIsScroll] = useState(false); //inital the scroll is false
  ...
  return (
    <>
      ...
      >
        ...
        <ul
          ref={sideMenuRef}
          className="md:hidden flex flex-col gap-4 py-20 px-10 fixed  -right-64 top-0 bottom-0
              w-64 z-50 h-screen bg-rose-50 transtion duration-500 dark:bg-darkHover dark:text-white"
        >
